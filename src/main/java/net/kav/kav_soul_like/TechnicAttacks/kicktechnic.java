...
public class kicktechnic extends Abstracttechnic{
    public kicktechnic(String name, int cooldown, int stamina, int speed) {
        super(name, cooldown, stamina, speed);
    }
    public kicktechnic(String name, int cooldown, int stamina) {
