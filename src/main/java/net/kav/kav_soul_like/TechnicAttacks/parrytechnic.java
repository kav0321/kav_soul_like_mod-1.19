...
public class parrytechnic extends Abstracttechnic{
    public parrytechnic(String name, int cooldown, int stamina, int speed) {
        super(name, cooldown, stamina, speed);
    }
    public parrytechnic(String name, int cooldown, int stamina) {
